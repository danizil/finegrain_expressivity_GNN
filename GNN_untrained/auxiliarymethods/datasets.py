...
def read_classes(ds_name):
    # Classes
    with open("GNN_untrained/datasets/" + ds_name + "/" + ds_name + "/raw/" + ds_name + "_graph_labels.txt", "r") as f:
...
def read_targets(ds_name):
    # Classes
    with open("GNN_untrained/datasets/" + ds_name + "/" + ds_name + "/raw/" + ds_name + "_graph_attributes.txt", "r") as f:
